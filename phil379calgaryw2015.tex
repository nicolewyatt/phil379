...
% - `injective`, `injection`: redefine for "one-one"

\settexttoken{injective}*{one-to-one}{one-to-ton}
\settexttoken{injection}*{one-to-one function}{one-to-one functions}

% - `surjective`, `surjection`: redefine for "onto"

\settexttoken{surjective}{onto}{onto}
\settexttoken{surjection}{onto function}{onto functions}
